...
import com.yll.bookmanager.shiro.AccountRealm;
import com.yll.bookmanager.shiro.JwtFilter;
...
public class ShiroConfig {
    ...
    public DefaultWebSecurityManager securityManager(AccountRealm accountRealm,
        ...
        // 在DefaultWebSecurityManager中为了关闭shiro自带的session方式，我们需要设置为false，
    ...
    //然后判断请求头中是否含有jwt的信息，有就登录，没有就跳过。跳过之后，有Controller中的shiro注解进行再次拦截，比如@RequiresAuthentication
    @Bean
